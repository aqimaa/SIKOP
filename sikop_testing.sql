...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Feb 2025 pada 00.30
...
('197810092005011002', 'ARI', 'Sumatra Barat'),
('198503052016011013', 'RAIHAN', 'Sumatra Barat'),
('198512102006011003', 'DAFA', 'Sumatra Barat'),
('198602152012011009', 'MUHAMMAD', 'Sumatra Barat'),
('198704202008011005', 'FAIZ', 'Jambi'),
('198710252014011011', 'AL-DZIKRO', 'Sumatra Barat'),
('198809302010011007', 'ATHAYA', 'Kep. Riau'),
('198907152018011015', 'CLARA', 'Sumatra Barat'),
('199003152007011004', 'MEYDIVA', 'Riau'),
('199101052011011008', 'INTA', 'Jambi'),
('199205252009011006', 'DIVA', 'Jambi'),
('199206102017011014', 'AQIMA', 'Riau'),
('199308202013011010', 'ADALAHITA', 'Jambi'),
('199310202019011016', 'MEY', 'Kep. Riau'),
('199412302015011012', 'YEZA', 'Kep. Riau');
...
(1, 1, '2025-01-30', 100000.00, 500001.00, 2500000.00, 'Tunai'),
...
--
-- Struktur dari tabel `simpanan_history`
--
...
--
-- Dumping data untuk tabel `simpanan_history`
--
...
--
-- Indeks untuk tabel `simpanan_history`
--
...
--
-- Ketidakleluasaan untuk tabel `simpanan_history`
--
ALTER TABLE `simpanan_history`
